...
export default function PermanentDeleteStudentsModal({
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            console.log('IDs selecionados para exclusão:', studentIds);
            console.log('Tipos dos IDs:', studentIds.map(id => typeof id));
            ...
            if (validIds.length !== studentIds.length) {
                console.warn('Alguns IDs não são válidos:', studentIds.filter(id => typeof id !== 'number' || isNaN(id)));
            }
